...
/**
 * How to gather an array of primitives from a predefined list
 * The fields informations are gathered through the AutoFormFieldProvider
 */
const MultiSelect = ({fieldProps}: Props) => {
          ...
          <FormControlWithError
            ...
            {/* <CreatableSelect */}
              <CreatableSelect
                ...
                name={name}
                ref={ref}
                options={Object.values(genField._def.values as Object).map(option => ({
                  value: option,
                  label: t(option),
                }))}
              />
